...
class Main:
    ...
    background = pygame.image.load('photos/mod_int.png')

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")

    # Loading signal images and font
    redSignal = pygame.image.load('photos/red.png')
    yellowSignal = pygame.image.load('photos/yellow.png')
    greenSignal = pygame.image.load('photos/green.png')
